...
game.Players.LocalPlayer.Character.Animation.Animate.Disabled = true
...
for i,v in pairs(mas:GetChildren()) do
	v.Parent = game:GetService("Players").LocalPlayer.Character.Animation
...
att(game.Players.LocalPlayer.Character['MeshPartAccessory'].Handle,Character.Model.Part,Vector3.new(0, 0.5, 0),Vector3.new(30,90,0))
...
local point = game.Players.LocalPlayer.Character:FindFirstChild("MeshPartAccessory")
...
if equipped then
Bullet.CFrame = point.Handle.CFrame * CFrame.new(math.random(-1,1),math.random(-1,1),math.random(0,0))
else
Bullet.CFrame = aaaa.Torso.CFrame * CFrame.new(0,-0.65,0)
end
end
