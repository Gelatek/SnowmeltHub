-- dare steal it and you'll be sorry | 7170689370,6202132428
...
TORSOFLING = false
BULLETFLING = true
loadstring(game:HttpGet("https://raw.githubusercontent.com/Gelatek/SnowmeltHub/main/Reanimate.lua"))()

loadstring(game:HttpGet('https://raw.githubusercontent.com/Gelatek/SnowmeltHub/main/Loadlibrary.lua'))()


wait(0.1)
Effects = { }
local Player = game:service'Players'.localPlayer
local chara = Player.Character.Animation
...
function att(p0,p1,p,o)
	dfdf = Instance.new("AlignPosition", p0)
	fsfgd = Instance.new("AlignOrientation", p0)
	hdghds = Instance.new("Attachment", p0)
	asddf = Instance.new("Attachment", p1)
	...
	if p0.Name == "Handle" then p0:BreakJoints() end
end
	function destroyshit(p0,p1)
	    p0.Attachment:Destroy()
	    p1.Attachment:Destroy()
	    p0.AlignPosition:Destroy()
	    p0.AlignOrientation:Destroy()
	end
att(game.Players.LocalPlayer.Character['K4LAS Mercenary [Back]'].Handle,Handaru,Vector3.new(0,-0.4,0),Vector3.new(5.08889e-14, 90, 20))

Knife2.Transparency = 1
KnifeH.Transparency = 0

if game.Players.LocalPlayer.Character:FindFirstChild("Bullet") then
Bullet = game.Players.LocalPlayer.Character.Bullet
...
local AG = Instance.new("BodyAngularVelocity", Bullet)
AG.MaxTorque = Vector3.new(math.huge,math.huge,math.huge)
AG.P = 1000000000000000000000000000
AG.AngularVelocity = Vector3.new(10000,10000,10000)
local Mouse = game.Players.LocalPlayer:GetMouse()
local MouseHolding = false
local HighLight = Instance.new("SelectionBox", Bullet)
HighLight.Adornee = Bullet
local getreal = game.Players.LocalPlayer.Character:FindFirstChild('Red SS').Handle
...
Bullet.RotVelocity = Vector3.new(60000,60000,60000)
    ...
    elseif shoote == false and attackwithknife == false then
      pcall(function() BP.Position = game.Players.LocalPlayer.Character.Animation:FindFirstChild("Torso").Position + Vector3.new(0,-0.4,0) end)
    elseif attackwithknife == true then
        	BP.Position = getreal.Position
	end
end
...
while true do
wait()
for i, v in pairs(game.Players.LocalPlayer.Character.Animation:GetDescendants()) do
...
att(game.Players.LocalPlayer.Character['Red SS'].Handle,KnifeH,Vector3.new(-0.2, -0.4, 0),Vector3.new(-50, 180, 180))

function wepknifestab()
destroyshit(game.Players.LocalPlayer.Character['Red SS'].Handle,KnifeH)
att(game.Players.LocalPlayer.Character['Red SS'].Handle,Knife2,Vector3.new(0,0,0),Vector3.new(-125, -0, 0))
attack = true
...
attack = false
attackwithknife = false
destroyshit(game.Players.LocalPlayer.Character['Red SS'].Handle,Knife2)
att(game.Players.LocalPlayer.Character['Red SS'].Handle,KnifeH,Vector3.new(-0.2, -0.4, 0),Vector3.new(-50, 180, 180))
end
