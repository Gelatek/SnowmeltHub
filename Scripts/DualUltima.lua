...
game.Players.LocalPlayer.Character.MeshPartAccessory.Name = "a"
if not game.Players.LocalPlayer.Character:FindFirstChild('MeshPartAccessory') then
game.StarterGui:SetCore("SendNotification",{
	Title = "Snowmelt Hub",
	Text = "Missing Hat! Check discord for hats.",
...
game.Players.LocalPlayer.Character.MeshPartAccessory.Name = "b"

Player=game:GetService("Players").LocalPlayer
Character=Player.Character.Animation
...
att(game.Players.LocalPlayer.Character.b.Handle, handle,Vector3.new(2, 2, 0),Vector3.new(-0, 0, 130))
att(game.Players.LocalPlayer.Character.a.Handle, handle2,Vector3.new(2, 2, 0),Vector3.new(-0, 0, 130))
if _G.bullet == true then
local aaaa = game.Players.LocalPlayer.Character:FindFirstChild("Animation")
local Bullet = game.Players.LocalPlayer.Character.Bullet
Bullet:ClearAllChildren()
local point1 = game.Players.LocalPlayer.Character:FindFirstChild("a").Handle
local point2 = game.Players.LocalPlayer.Character:FindFirstChild("b").Handle
...
local function attack()
 matee = math.random(1,2)
    Bullet.RotVelocity = Vector3.new(60000,60000,60000)
wait(0.4)
    if matee == 1 then
    Bullet.CFrame = point1.CFrame * CFrame.new(math.random(-1,1),math.random(-1,1),math.random(0,0))
    elseif matee == 2 then
    Bullet.CFrame = point2.CFrame * CFrame.new(math.random(-1,1),math.random(-1,1),math.random(0,0))
    end
end
