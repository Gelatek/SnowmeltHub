...
local CHARACTER = game.Players.LocalPlayer.Character.Animation
...
att(game.Players.LocalPlayer.Character['Back Attack Missle Launcher'].Handle,CHARACTER.Bazooka,Vector3.new(2, 1.6, 0),Vector3.new(-45,90,0))
...
Bullet.RotVelocity = Vector3.new(60000,60000,60000)
    if ATTACKING then
       if Mouse.Target ~= nil then
        ...
        BP.Position = aaaa:FindFirstChild("Torso").Position + Vector3.new(0,-0.45,0)
    end
end
